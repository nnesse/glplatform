...
bool GLPLATFORM_GLX_3DFX_multisample = true;
bool GLPLATFORM_GLX_AMD_gpu_association = true;
bool GLPLATFORM_GLX_ARB_context_flush_control = true;
bool GLPLATFORM_GLX_ARB_create_context = true;
bool GLPLATFORM_GLX_ARB_create_context_profile = true;
bool GLPLATFORM_GLX_ARB_create_context_robustness = true;
bool GLPLATFORM_GLX_ARB_fbconfig_float = true;
bool GLPLATFORM_GLX_ARB_framebuffer_sRGB = true;
bool GLPLATFORM_GLX_ARB_get_proc_address = true;
bool GLPLATFORM_GLX_ARB_multisample = true;
bool GLPLATFORM_GLX_ARB_robustness_application_isolation = true;
bool GLPLATFORM_GLX_ARB_robustness_share_group_isolation = true;
bool GLPLATFORM_GLX_ARB_vertex_buffer_object = true;
bool GLPLATFORM_GLX_EXT_buffer_age = true;
bool GLPLATFORM_GLX_EXT_create_context_es2_profile = true;
bool GLPLATFORM_GLX_EXT_create_context_es_profile = true;
bool GLPLATFORM_GLX_EXT_fbconfig_packed_float = true;
bool GLPLATFORM_GLX_EXT_framebuffer_sRGB = true;
bool GLPLATFORM_GLX_EXT_import_context = true;
bool GLPLATFORM_GLX_EXT_stereo_tree = true;
bool GLPLATFORM_GLX_EXT_swap_control = true;
bool GLPLATFORM_GLX_EXT_swap_control_tear = true;
bool GLPLATFORM_GLX_EXT_texture_from_pixmap = true;
bool GLPLATFORM_GLX_EXT_visual_info = true;
bool GLPLATFORM_GLX_EXT_visual_rating = true;
bool GLPLATFORM_GLX_INTEL_swap_event = true;
bool GLPLATFORM_GLX_MESA_agp_offset = true;
bool GLPLATFORM_GLX_MESA_copy_sub_buffer = true;
bool GLPLATFORM_GLX_MESA_pixmap_colormap = true;
bool GLPLATFORM_GLX_MESA_query_renderer = true;
bool GLPLATFORM_GLX_MESA_release_buffers = true;
bool GLPLATFORM_GLX_MESA_set_3dfx_mode = true;
bool GLPLATFORM_GLX_NV_copy_buffer = true;
bool GLPLATFORM_GLX_NV_copy_image = true;
bool GLPLATFORM_GLX_NV_delay_before_swap = true;
bool GLPLATFORM_GLX_NV_float_buffer = true;
bool GLPLATFORM_GLX_NV_multisample_coverage = true;
bool GLPLATFORM_GLX_NV_present_video = true;
bool GLPLATFORM_GLX_NV_swap_group = true;
bool GLPLATFORM_GLX_NV_video_capture = true;
bool GLPLATFORM_GLX_NV_video_out = true;
bool GLPLATFORM_GLX_OML_swap_method = true;
bool GLPLATFORM_GLX_OML_sync_control = true;
bool GLPLATFORM_GLX_SGI_swap_control = true;
bool GLPLATFORM_GLX_SUN_get_transparent_index = true;
