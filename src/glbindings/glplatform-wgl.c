/* C WGL bindings generated by glbindify 0.5 */
...
bool GLPLATFORM_WGL_3DFX_multisample = true;
bool GLPLATFORM_WGL_3DL_stereo_control = true;
bool GLPLATFORM_WGL_AMD_gpu_association = true;
bool GLPLATFORM_WGL_ARB_buffer_region = true;
bool GLPLATFORM_WGL_ARB_context_flush_control = true;
bool GLPLATFORM_WGL_ARB_create_context = true;
bool GLPLATFORM_WGL_ARB_create_context_profile = true;
bool GLPLATFORM_WGL_ARB_create_context_robustness = true;
bool GLPLATFORM_WGL_ARB_extensions_string = true;
bool GLPLATFORM_WGL_ARB_framebuffer_sRGB = true;
bool GLPLATFORM_WGL_ARB_make_current_read = true;
bool GLPLATFORM_WGL_ARB_multisample = true;
bool GLPLATFORM_WGL_ARB_pbuffer = true;
bool GLPLATFORM_WGL_ARB_pixel_format = true;
bool GLPLATFORM_WGL_ARB_pixel_format_float = true;
bool GLPLATFORM_WGL_ARB_render_texture = true;
bool GLPLATFORM_WGL_ARB_robustness_application_isolation = true;
bool GLPLATFORM_WGL_ARB_robustness_share_group_isolation = true;
bool GLPLATFORM_WGL_ATI_pixel_format_float = true;
bool GLPLATFORM_WGL_EXT_create_context_es2_profile = true;
bool GLPLATFORM_WGL_EXT_create_context_es_profile = true;
bool GLPLATFORM_WGL_EXT_depth_float = true;
bool GLPLATFORM_WGL_EXT_display_color_table = true;
bool GLPLATFORM_WGL_EXT_extensions_string = true;
bool GLPLATFORM_WGL_EXT_framebuffer_sRGB = true;
bool GLPLATFORM_WGL_EXT_make_current_read = true;
bool GLPLATFORM_WGL_EXT_multisample = true;
bool GLPLATFORM_WGL_EXT_pbuffer = true;
bool GLPLATFORM_WGL_EXT_pixel_format = true;
bool GLPLATFORM_WGL_EXT_pixel_format_packed_float = true;
bool GLPLATFORM_WGL_EXT_swap_control = true;
bool GLPLATFORM_WGL_EXT_swap_control_tear = true;
bool GLPLATFORM_WGL_I3D_digital_video_control = true;
bool GLPLATFORM_WGL_I3D_gamma = true;
bool GLPLATFORM_WGL_I3D_genlock = true;
bool GLPLATFORM_WGL_I3D_image_buffer = true;
bool GLPLATFORM_WGL_I3D_swap_frame_lock = true;
bool GLPLATFORM_WGL_I3D_swap_frame_usage = true;
bool GLPLATFORM_WGL_NV_DX_interop = true;
bool GLPLATFORM_WGL_NV_DX_interop2 = true;
bool GLPLATFORM_WGL_NV_copy_image = true;
bool GLPLATFORM_WGL_NV_delay_before_swap = true;
bool GLPLATFORM_WGL_NV_float_buffer = true;
bool GLPLATFORM_WGL_NV_gpu_affinity = true;
bool GLPLATFORM_WGL_NV_multisample_coverage = true;
bool GLPLATFORM_WGL_NV_present_video = true;
bool GLPLATFORM_WGL_NV_render_depth_texture = true;
bool GLPLATFORM_WGL_NV_render_texture_rectangle = true;
bool GLPLATFORM_WGL_NV_swap_group = true;
bool GLPLATFORM_WGL_NV_vertex_array_range = true;
bool GLPLATFORM_WGL_NV_video_capture = true;
bool GLPLATFORM_WGL_NV_video_output = true;
bool GLPLATFORM_WGL_OML_sync_control = true;
